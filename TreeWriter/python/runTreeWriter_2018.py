...
#  ~process.source = cms.Source("PoolSource", fileNames=cms.untracked.vstring(options.inputFiles), eventsToProcess = cms.untracked.VEventRange("1:20170:33097835-1:20170:33098267"))
...
process.TreeWriter.ttbarGenInfo=(dataset.startswith("/TT") or dataset.startswith("/tt") or dataset.startswith("/SMS-T") or dataset.startswith("/b_bbar_4l") or dataset.startswith("/BBLLNuNu"))
process.TreeWriter.ttbarPseudoInfo=(dataset.startswith("/TT") or dataset.startswith("/tt") or dataset.startswith("/SMS-T") or dataset.startswith("/b_bbar_4l") or dataset.startswith("/BBLLNuNu"))
process.TreeWriter.bFragInfo=(dataset.startswith("/TT") or dataset.startswith("/tt") or dataset.startswith("/ST") or dataset.startswith("/b_bbar_4l") or dataset.startswith("/BBLLNuNu"))
