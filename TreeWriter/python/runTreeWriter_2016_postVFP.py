...
#  ~options.inputFiles =    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL16MiniAOD/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v13-v2/00000/0393578C-5B4A-124C-9442-48A3BD2096EA.root',     #miniAODv1
options.inputFiles =    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL16MiniAODv2/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/270000/B4388342-8884-2A48-A3C5-A092127DC75B.root',      #miniAODv2
...
process.PFJetIDTightLepVeto = cms.EDProducer('PatJetIDValueMapProducer',
    ...
    filterParams = cms.PSet(
        version = cms.string('RUN2UL16CHS'),
...
process.PFJetIDTightLepVetoPuppi.filterParams.version = cms.string("RUN2UL16PUPPI")
...
process.TreeWriter = cms.EDAnalyzer('TreeWriter',
                                    ...
                                    pfJetIDSelector=cms.PSet(version=cms.string('RUN2UL16CHS'), quality=cms.string('TIGHT')),
                                    ...
                                    year=cms.untracked.string("2016nonAPV"),  # needed for xy MET correction
)
