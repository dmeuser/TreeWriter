...
#  ~options.inputFiles = 'root://cms-xrd-global.cern.ch//store/data/Run2016G/DoubleEG/MINIAOD/17Jul2018-v1/20000/FCA1F6F9-279B-E811-B35B-0425C5DE7BEE.root'
...
if isRealData:
        ...
        process.GlobalTag.toGet = cms.VPSet(
            cms.PSet(
                ...
                tag = cms.string('JetCorrectorParametersCollection_Sum16_07Aug2017V11_and_Fall17_17Nov2017V6_DATA_AK4PFchs')))
...
#  ~process.source = cms.Source("PoolSource", fileNames=cms.untracked.vstring(options.inputFiles), eventsToProcess = cms.untracked.VEventRange("280016:11:17896469"))
