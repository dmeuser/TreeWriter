...
#  ~options.inputFiles =    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL17MiniAOD/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_mc2017_realistic_v6-v2/00000/054AE840-3924-BD47-880F-12FA2F909901.root',       #miniAODv1
...
options.inputFiles =    'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL17MiniAODv2/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_mc2017_realistic_v9-v1/230000/E4309DB8-B4E5-0A42-8883-36A6D34EC9F8.root',       #miniAODv2
...
process.updatedPatJetsUpdatedJECIDUserData = cms.EDProducer("PATJetUserDataEmbedder",
    src = cms.InputTag("updatedPatJetsUpdatedJECID"),
    userFloats = cms.PSet(
...
collection = 'updatedPatJetsUpdatedJECIDUserData'
...
process.updatedPatJetsUpdatedJECIDUserDataBregr = cms.EDProducer('PATJetUserDataEmbedder',
   src = cms.InputTag(collection),
   userFloats = cms.PSet(
...
process.TreeWriter = cms.EDAnalyzer('TreeWriter',
                                    ...
                                    jets = cms.InputTag("updatedPatJetsUpdatedJECIDUserDataBregr"),    #Use unsmeared jets and apply JER locally
                                    ...
                                    year=cms.untracked.string("2017"),  # needed for xy MET correction
)
...
process.p = cms.Path(
    ...
    *process.bJetVars
    *process.updatedPatJetsUpdatedJECIDUserData
    *process.bjetNN
    *process.updatedPatJetsUpdatedJECIDUserDataBregr
